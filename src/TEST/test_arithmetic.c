...
START_TEST(d3_add_1) {
  d3_decimal src1, src2, origin, result;
  ...
  value_type_result = d3_add(src1, src2, &result);
  value_type_origin = 0;
...
START_TEST(d3_sub_1) {
  ...
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b00000000000000000000000000000000;
  value_type_result = d3_sub(src1, src2, &result);
  value_type_origin = 0;
  origin.bits[0] = 0b00000000000000000000000000000010;
  origin.bits[1] = 0b00000000000000000000000000000000;
  origin.bits[2] = 0b00000000000000000000000000000000;
...
START_TEST(d3_sub_27) {
  d3_decimal src1, src2, result;
  int value_type_result, value_type_origin;
  src1.bits[0] = 0b00000000000000000000000000000000;
  src1.bits[1] = 0b00000000000000000000000000000000;
  src1.bits[2] = 0b00000000000000000000000000000000;
...
//
START_TEST(d3_div_1) {
  d3_decimal src1, src2, result, origin;
  // 30064771176
  // 3
  // 10021590392
  ...
  origin.bits[2] = 0b00000000000000000000000000000000;
  origin.bits[3] = 0b00000000000000000000000000000000;
  int check = d3_div(src1, src2, &result);
  int check_origin = 0;
...
START_TEST(d3_div_2) {
  ...
  int b = -2;
  int res_our_dec = 0;
  d3_from_int_to_decimal(a, &src1);
  d3_from_int_to_decimal(b, &src2);
  int res_origin = -16384;
  int check = d3_div(src1, src2, &result);
  int check_origin = 0;
  d3_from_decimal_to_int(result, &res_our_dec);
...
START_TEST(d3_div_7) {
  d3_decimal src1, src2, result, origin;
  d3_from_int_to_decimal(-101, &src1);
  d3_from_float_to_decimal(10.1, &src2);
  int check = d3_div(src1, src2, &result);
  int check_origin = 0;
...
START_TEST(d3_div_10) {
  d3_decimal src1, src2, result;
  float a = -115.2;
  float b = 0.0;
  d3_from_float_to_decimal(a, &src1);
  d3_from_float_to_decimal(b, &src2);
  int check = d3_div(src1, src2, &result);
  int check_origin = 3;
...
START_TEST(d3_div_12) {
  d3_decimal src1, src2;
...
START_TEST(d3_div_14) {
  d3_decimal val1 = {{2, 0, 0, 0}};
  d3_decimal val2 = {{0, 0, 0, 0}};
  d3_decimal res = {{0}};
  ck_assert_int_eq(3, d3_div(val1, val2, &res));
}
END_TEST

START_TEST(d3_div_15) {
  d3_decimal value_1 = {{15, 0, 0, 0}};
  d3_decimal value_2 = {{0, 0, 0, 0}};
  d3_decimal result = {{0, 0, 0, 0}};
  d3_decimal check = {{0, 0, 0, 0}};
  int return_value = d3_div(value_1, value_2, &result);
  ck_assert_int_eq(d3_is_equal(result, check), 1);
...
START_TEST(d3_mul_1) {
  ...
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b00000000000000000000000000000000;
  value_type_result = d3_mul(src1, src2, &result);
  value_type_origin = 0;
...
START_TEST(d3_mul_23) {
  d3_decimal val1 = {{2, 0, 0, 0}};
  d3_decimal val2 = {{2, 0, 0, 0}};
  d3_decimal res = {{0}};
  ck_assert_int_eq(0, d3_mul(val1, val2, &res));
}
END_TEST

START_TEST(d3_mul_24) {
  d3_decimal val1 = {{8, 0, 0, 0}};
  d3_decimal val2 = {{2, 0, 0, 0}};
  d3_decimal res = {{0}};
  ck_assert_int_eq(0, d3_mul(val1, val2, &res));
}
...
START_TEST(d3_mul_25) {
  d3_decimal val1 = {{2, 0, 0, 0}};
  d3_decimal val2 = {{8, 0, 0, 0}};
  d3_decimal res = {{0}};
  ck_assert_int_eq(0, d3_mul(val1, val2, &res));
}
END_TEST
...
Suite *test_arithmetic() {
  Suite *s = suite_create("d3_arithmetic");
  TCase *o = tcase_create("d3_arithmetic");
  suite_add_tcase(s, o);

  tcase_add_test(o, d3_add_1);
  tcase_add_test(o, d3_add_2);
  tcase_add_test(o, d3_add_3);
  tcase_add_test(o, d3_add_4);
  tcase_add_test(o, d3_add_5);
  tcase_add_test(o, d3_add_6);
  tcase_add_test(o, d3_add_7);
  tcase_add_test(o, d3_add_8);
  tcase_add_test(o, d3_add_9);
  tcase_add_test(o, d3_add_10);
  tcase_add_test(o, d3_add_11);
  tcase_add_test(o, d3_add_12);
  tcase_add_test(o, d3_add_13);
  tcase_add_test(o, d3_add_14);
  tcase_add_test(o, d3_add_15);
  tcase_add_test(o, d3_add_16);
  tcase_add_test(o, d3_add_17);
  tcase_add_test(o, d3_add_18);
  tcase_add_test(o, d3_add_19);
  tcase_add_test(o, d3_add_20);
  tcase_add_test(o, d3_add_21);
  tcase_add_test(o, d3_add_22);
  tcase_add_test(o, d3_add_23);
  tcase_add_test(o, d3_add_24);
  tcase_add_test(o, d3_add_25);
  tcase_add_test(o, d3_add_26);
  tcase_add_test(o, d3_add_27);
  tcase_add_test(o, d3_add_28);
  tcase_add_test(o, d3_add_29);
  tcase_add_test(o, d3_add_30);

  tcase_add_test(o, d3_sub_1);
  tcase_add_test(o, d3_sub_2);
  tcase_add_test(o, d3_sub_3);
  tcase_add_test(o, d3_sub_4);
  tcase_add_test(o, d3_sub_5);
  tcase_add_test(o, d3_sub_6);
  tcase_add_test(o, d3_sub_7);
  tcase_add_test(o, d3_sub_8);
  tcase_add_test(o, d3_sub_9);
  tcase_add_test(o, d3_sub_10);
  tcase_add_test(o, d3_sub_11);
  tcase_add_test(o, d3_sub_12);
  tcase_add_test(o, d3_sub_13);
  tcase_add_test(o, d3_sub_14);
  tcase_add_test(o, d3_sub_15);
  tcase_add_test(o, d3_sub_16);
  tcase_add_test(o, d3_sub_17);
  tcase_add_test(o, d3_sub_18);
  tcase_add_test(o, d3_sub_19);
  tcase_add_test(o, d3_sub_20);
  tcase_add_test(o, d3_sub_21);
  tcase_add_test(o, d3_sub_22);
  tcase_add_test(o, d3_sub_23);
  tcase_add_test(o, d3_sub_24);
  tcase_add_test(o, d3_sub_25);
  tcase_add_test(o, d3_sub_26);
  tcase_add_test(o, d3_sub_27);
  tcase_add_test(o, d3_sub_28);
  tcase_add_test(o, d3_sub_29);
  tcase_add_test(o, d3_sub_30);

  tcase_add_test(o, d3_div_1);
  tcase_add_test(o, d3_div_2);
  tcase_add_test(o, d3_div_3);
  tcase_add_test(o, d3_div_4);
  tcase_add_test(o, d3_div_5);
  tcase_add_test(o, d3_div_6);
  tcase_add_test(o, d3_div_7);
  tcase_add_test(o, d3_div_8);
  tcase_add_test(o, d3_div_9);
  tcase_add_test(o, d3_div_10);
  tcase_add_test(o, d3_div_11);
  tcase_add_test(o, d3_div_12);
  tcase_add_test(o, d3_div_13);
  tcase_add_test(o, d3_div_14);
  tcase_add_test(o, d3_div_15);

  tcase_add_test(o, d3_mul_1);
  tcase_add_test(o, d3_mul_2);
  tcase_add_test(o, d3_mul_3);
  tcase_add_test(o, d3_mul_4);
  tcase_add_test(o, d3_mul_5);
  tcase_add_test(o, d3_mul_6);
  tcase_add_test(o, d3_mul_7);
  tcase_add_test(o, d3_mul_8);
  tcase_add_test(o, d3_mul_9);
  tcase_add_test(o, d3_mul_10);
  tcase_add_test(o, d3_mul_11);
  tcase_add_test(o, d3_mul_12);
  tcase_add_test(o, d3_mul_13);
  tcase_add_test(o, d3_mul_14);
  tcase_add_test(o, d3_mul_15);
  tcase_add_test(o, d3_mul_16);
  tcase_add_test(o, d3_mul_17);
  tcase_add_test(o, d3_mul_18);
  tcase_add_test(o, d3_mul_19);
  tcase_add_test(o, d3_mul_20);
  tcase_add_test(o, d3_mul_21);
  tcase_add_test(o, d3_mul_22);
  tcase_add_test(o, d3_mul_23);
  tcase_add_test(o, d3_mul_24);
  tcase_add_test(o, d3_mul_25);
